...
def train():
    ...
    media_mode = "feature" if data_args.store_feature is True else "image"
    ...
    training_args = transformers.TrainingArguments(
        ...
        output_dir=f'{task_name}_{model_name}_{media_mode}_lr{training_args.learning_rate}{pretraining}',
